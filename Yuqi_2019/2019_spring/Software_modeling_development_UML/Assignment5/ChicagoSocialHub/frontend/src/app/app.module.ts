...
import { SmaStationChartComponent } from './components/sma-station-chart/sma-station-chart.component';
import { SmaStationChartChildComponent } from './components/sma-station-chart/sma-station-chart-child/sma-station-chart-child.component';
...
const routes: Routes = [
  ...
  children: [{path: 'bar_chart_review', component: BarChartReviewComponent}]},
  { path: 'list_of_stations', component: ListOfStationsComponent },
  { path: 'line_chart_divvy', component: LineChartDivvyComponent },
  { path: 'sma_station_chart', component: SmaStationChartComponent},
...
@NgModule({
  declarations: [
    ...
    SmaStationChartComponent,
    SmaStationChartChildComponent,
  ],
  imports: [
    BrowserModule,
