...
export class PlacesService {
  ...
  findEntireCityDivvyStationsInformationOneDay() {
    return this.http.post(`${this.uri}/stations/entire_city_stations_one_day`, httpOptions);
  }

  getEntireCityDivvyStationsInformationOneDay() {
    return this.http.get(`${this.uri}/stations/entire_city_stations_one_day`);
  }
