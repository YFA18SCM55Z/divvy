...
@Component({
  selector: 'app-sma-station-chart',
  templateUrl: './sma-station-chart.component.html',
  encapsulation: ViewEncapsulation.None,
  styleUrls: ['./sma-station-chart.component.css']
})
export class SmaStationChartComponent implements OnInit, OnDestroy {
  title = 'Line Chart';
